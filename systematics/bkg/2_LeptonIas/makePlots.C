...
int makePlots(int pdgId, double ptCut, double ecaloCut, double iasCut){
  ...
  TCanvas *c1 = drawRatioPlot(pred.histoASmi,SR.histoASmi,data.histoASmi,Form("I_{as} pdgId=%i",pdgId),Form("plots/hASmi_%i_ASmiShape_ptCut%.0f_iasCut0p%.0f_EcaloLe%.0f.pdf",pdgId,ptCut,iasCut*100,ecaloCut), ecaloCut);
